...
import com.herohiman.tournant.databinding.RecyclerItemTextBinding
import com.herohiman.tournant.findFirstAmount
import com.herohiman.tournant.findFirstIngredientWithAmount
import com.herohiman.tournant.findTimeExpressions
import com.herohiman.tournant.setClickableSpan
import com.herohiman.tournant.toRangeList
import com.herohiman.tournant.toStringForCooks
import com.herohiman.tournant.withFractionsToDouble
			...
			paragraph.findTimeExpressions(dashWords, "(h)|$hString", "(min)|$minString", "(s)|$sString").forEach { timeString ->
				paragraph.setClickableSpan(timeString.position) {
					if (timeString.seconds > 3600)
						instructionsTextInterface.showAlarmDialog((timeString.seconds / 60.0).roundToInt())
					else
